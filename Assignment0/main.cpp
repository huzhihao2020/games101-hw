...
int main(){
    ...
    Eigen::Vector3f P_p(2.0,1.0,1.0);

    Eigen::Matrix3f M_rot, M_trans;
    float theta = (45.0/180) * PI;
    M_rot <<   std::cos(theta),    -std::sin(theta),   0,
    ...
    std::cout << M_trans * M_rot * P_p << std::endl;
     return 0;
}